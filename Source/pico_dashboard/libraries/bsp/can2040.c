...
// Place can2040 functions in RAM — XIP flash latency prevents timely ACK
// (see https://github.com/KevinOConnor/can2040/issues/74)
#define CAN2040_RAM __attribute__((section(".time_critical.can2040")))
...
data_state_go_error(struct can2040 *cd)
{
    ...
    cd->stats.parse_error_state = cd->parse_state;
